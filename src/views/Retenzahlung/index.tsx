...
const Ratenzahlung = (): JSX.Element => {
  const [photoCapturePopup, setPhotoCapturePopup] = useState<boolean>(false);
  ...
  return (
    <RatenzahlungWrapper>
            ...
            <div className="wrapper">
              <form>
                ...
                <div className="capture">
                  <h5>Ausweiskopie</h5>
                  <div className="action">
                    <button type="button" onClick={() => setPhotoCapturePopup(true)}>
      ...
      <Contact />
      {photoCapturePopup&&
        <PhotoCapture opened={true} onClose={() => setPhotoCapturePopup(false)} />
      }
    </RatenzahlungWrapper>
  );
};
